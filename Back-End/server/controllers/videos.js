...
export const getVideo = async(req, res) => {
  ...
  const [datosVideo] = await pool.query("Select urlVideo, arrayPiques, urlHeatmap, velocidades, titulo, tipo FROM videos WHERE idUsuario = ? AND idcloudinary = ?", [idUsuario, idCloudinary])
  ...
  return res.status(200).json(urlVideo, arrayPiques, urlHeatmap, velocidades, titulo, tipo)
}
