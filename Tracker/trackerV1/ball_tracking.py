...
while True:
	...
	framePrueba = cv2.threshold(framePrueba, 100, 255, cv2.THRESH_BINARY)
	framePrueba = framePrueba[1]
	contornos = cv2.findContours(framePrueba, cv2.RETR_EXTERNAL,
		cv2.CHAIN_APPROX_SIMPLE)

	img_contours = np.zeros(framePrueba.shape)
