...
function CardVideo({title, thumbnail, videoType, otherInfo}) {
  return (
    <>
      <div className="card-video-container">
        <div id="thumbnail-box" className={thumbnail}>
        <svg width="64" height="65" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect y="0.0605469" width="64" height="64" rx="32" fill="#FCFCFC"/>
          <path d="M40.7921 33.6545L28.0661 41.0385C26.9861 41.6645 25.6001 40.9065 25.6001 39.6445V24.8765C25.6001 23.6165 26.9841 22.8565 28.0661 23.4845L40.7921 30.8685C41.0378 31.0087 41.242 31.2114 41.384 31.4561C41.5261 31.7007 41.6009 31.9786 41.6009 32.2615C41.6009 32.5443 41.5261 32.8222 41.384 33.0668C41.242 33.3115 41.0378 33.5142 40.7921 33.6545V33.6545Z" fill="#4ECB71"/>
        </svg>
        </div>
