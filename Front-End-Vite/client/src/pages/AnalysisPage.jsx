        ...
        <div className="content-ap">
          <section className="profile-data">
            <div className="profile-picture-main">
              ...
              >
                <path
                  d="M50.3483 50.347C61.8943 50.347 71.2542 40.9871 71.2542 29.4411C71.2542 17.8951 61.8943 8.53516 50.3483 8.53516C38.8023 8.53516 29.4424 17.8951 29.4424 29.4411C29.4424 40.9871 38.8023 50.347 50.3483 50.347Z"
                  stroke="#151F27"
                  strokeWidth="6.96864"
                />
                <path
                  d="M71.2541 58.709H72.7259C75.7826 58.7098 78.7339 59.8269 81.0252 61.8502C83.3165 63.8736 84.79 66.664 85.1691 69.6971L86.8039 82.7592C86.951 83.9359 86.8461 85.1304 86.4962 86.2635C86.1463 87.3965 85.5594 88.4422 84.7745 89.3311C83.9896 90.22 83.0246 90.9318 81.9435 91.4193C80.8625 91.9068 79.6901 92.1587 78.5043 92.1585H22.1921C21.0062 92.1587 19.8339 91.9068 18.7528 91.4193C17.6718 90.9318 16.7068 90.22 15.9219 89.3311C15.1369 88.4422 14.5501 87.3965 14.2002 86.2635C13.8503 85.1304 13.7454 83.9359 13.8924 82.7592L15.5231 69.6971C15.9023 66.6625 17.3771 63.871 19.6701 61.8475C21.9631 59.8239 24.9164 58.7078 27.9747 58.709H29.4422"
                  stroke="#151F27"
                  strokeWidth="6.96864"
                  strokeLinecap="round"
          ...
          <section className="search-filters">
            ...
            <div className="filters">
              <div className="btn-filters" onClick={toggleState}>
                ...
                >
                  <path
                    d="M1 2.83789H4.55571M17.0007 2.83789H8.11142M1 9.06038H11.6671M17.0007 9.06038H15.2228M1 15.2829H2.77785M17.0007 15.2829H6.33356"
                    stroke="#4ECB71"
                    strokeWidth="1.75"
                    strokeLinecap="round"
                  />
                  <path
                    d="M6.33352 4.61626C7.3154 4.61626 8.11137 3.82028 8.11137 2.8384C8.11137 1.85652 7.3154 1.06055 6.33352 1.06055C5.35164 1.06055 4.55566 1.85652 4.55566 2.8384C4.55566 3.82028 5.35164 4.61626 6.33352 4.61626Z"
                    stroke="#4ECB71"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
                  <path
                    d="M13.4448 10.8389C14.4267 10.8389 15.2227 10.0429 15.2227 9.06106C15.2227 8.07918 14.4267 7.2832 13.4448 7.2832C12.463 7.2832 11.667 8.07918 11.667 9.06106C11.667 10.0429 12.463 10.8389 13.4448 10.8389Z"
                    stroke="#4ECB71"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
                  <path
                    d="M4.55569 17.0596C5.53757 17.0596 6.33354 16.2636 6.33354 15.2818C6.33354 14.2999 5.53757 13.5039 4.55569 13.5039C3.5738 13.5039 2.77783 14.2999 2.77783 15.2818C2.77783 16.2636 3.5738 17.0596 4.55569 17.0596Z"
                    stroke="#4ECB71"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
                ...
                <svg
                  className={
                    toggle ? "arrow-filter inactive-arrow" : "arrow-filter"
                  }
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <div
                className={
                  toggle
                    ...
                    : "filters-container filters-invisible"
                }
                    ...
                    <FormControl className="form-control">
                      ...
                      >
                        ...
                        <FormControlLabel
                          value="-10min"
                          control={<Radio />}
                          label="Menos de 10 minutos"
                        />
                        <FormControlLabel
                          value="10min-30min"
                          control={<Radio />}
                          label="Entre 10 y 30 minutos"
                        />
                        <FormControlLabel
                          value="+30min"
                          control={<Radio />}
