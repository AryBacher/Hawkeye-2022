            ...
            <div className='filters'>
              <div className='btn-filters' onClick={toggleState}>
                <svg className="settings-filter" width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 2.83789H4.55571M17.0007 2.83789H8.11142M1 9.06038H11.6671M17.0007 9.06038H15.2228M1 15.2829H2.77785M17.0007 15.2829H6.33356" stroke="#4ECB71" strokeWidth="1.75" strokeLinecap="round"/>
                  <path d="M6.33352 4.61626C7.3154 4.61626 8.11137 3.82028 8.11137 2.8384C8.11137 1.85652 7.3154 1.06055 6.33352 1.06055C5.35164 1.06055 4.55566 1.85652 4.55566 2.8384C4.55566 3.82028 5.35164 4.61626 6.33352 4.61626Z" stroke="#4ECB71" strokeWidth="1.5" strokeLinecap="round"/>
                  <path d="M13.4448 10.8389C14.4267 10.8389 15.2227 10.0429 15.2227 9.06106C15.2227 8.07918 14.4267 7.2832 13.4448 7.2832C12.463 7.2832 11.667 8.07918 11.667 9.06106C11.667 10.0429 12.463 10.8389 13.4448 10.8389Z" stroke="#4ECB71" strokeWidth="1.5" strokeLinecap="round"/>
                  <path d="M4.55569 17.0596C5.53757 17.0596 6.33354 16.2636 6.33354 15.2818C6.33354 14.2999 5.53757 13.5039 4.55569 13.5039C3.5738 13.5039 2.77783 14.2999 2.77783 15.2818C2.77783 16.2636 3.5738 17.0596 4.55569 17.0596Z" stroke="#4ECB71" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
